...
while (True):
  ...
  if (loud_cpu <60 and loud_mem<90):
    #subprocess.Popen(["python","CheckProxy2.py",checkDataUrl,token], creationflags=subprocess.CREATE_NEW_CONSOLE)
    subprocess.Popen(["python","CheckProxy2.py",checkDataUrl,token])
  else:
